...
import com.albertribas_ericcaballero_albertmarlet.proyecto_final.Request.RefreshPushRequest;
...
public class RegistrationIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(String token) {
        ...
        if (Utils.getID() != null && !Utils.getID().equals("")){
