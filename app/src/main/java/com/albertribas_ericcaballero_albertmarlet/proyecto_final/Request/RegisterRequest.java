 ...
 */
public abstract class RegisterRequest extends AsyncTask<String, Void, String> {
    public String aux = "";

    protected String doInBackground(String... urls) {
        try {
            URL url = new URL(Utils.URL + "/users/login/register"); //the URL we will send the request to
