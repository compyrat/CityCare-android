...
/**
 * Created by albertmarnun on 04/05/2016.
 */
public abstract class IncidenceRequest extends AsyncTask<String, Void, String> {

    public String aux = "";

    protected String doInBackground(String... urls) {
        try {
            URL url = new URL(Utils.URL + "/incidencias/getAll/" + Utils.getID() + "/WithPag/" + urls[0] + "?delete=" + urls[1]); //the URL we will send the request to
