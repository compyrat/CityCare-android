...
/**
 * Created by albertribgar on 30/05/2016.
 */
public abstract class UpdateUserRequest extends AsyncTask<String, Void, String> {

    protected String doInBackground(String... urls) {
        try {
            URL url = new URL(Utils.URL + "/users/editUserInfo"); //the URL we will send the request to
